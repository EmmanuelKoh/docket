...
Count as tasks: direct requests ("can you send me…", "please pay…"), reminders with an action ("insurance is due next week"), commitments the recipient made ("I'll bring the cables tomorrow" sent BY the recipient is not visible here, but "you said you'd bring the cables" is a task), appointments requiring preparation.
